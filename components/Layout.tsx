...
import { LayoutDashboard, PieChart, Settings, Plus, AlertTriangle, CheckCircle, Info } from 'lucide-react';
...
const Layout: React.FC<LayoutProps> = ({ onOpenAddModal }) => {
  ...
  return (
    <div className="flex flex-col h-[100dvh] bg-gray-50 dark:bg-gray-900 overflow-hidden transition-colors duration-200">
      <main className="flex-1 overflow-y-auto no-scrollbar overscroll-y-contain [-webkit-overflow-scrolling:touch]">
